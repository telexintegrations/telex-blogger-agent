...
namespace TelexBloggerAgent.Data
{
    public class MongoDbContext
    {
        ...
        public MongoDbContext(IOptions<MongoDbConfig> options, HttpHelper httphelper)
        {
        ...
        public async Task<TelexApiResponse<Document<T>>> AddAsync<T>(T document)
        {
            ...
            if (typeof(T) == typeof(Company)) tagName = nameof(T);
            else if (typeof(T) == typeof(Conversation)) tagName = CollectionType.Convesation;
            else if (typeof(T) == typeof(Blog)) tagName = CollectionType.Blog;
